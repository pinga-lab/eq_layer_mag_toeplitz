...
%	{(a) Predicted data using our method for the interpolated $10,000 \times 131$ regular grid. (b) Residuals between the observed (\ref{fig:carajas_real_data_decimated_gridline}) and the predicted data (panel a), with mean of $0.07979$ nT and standard deviation of $0.5060$ nT.}
%	\label{fig:carajas_gz_predito_mag_gridline}
%}
%
%\plot{carajas_tf_predicted_decimated}{width=8cm}{
%	{(a) Predicted data using our method for the decimated $10,000 \times 131$ irregular grid. (b) Residuals between the observed (\ref{fig:carajas_real_data_decimated_gridline}) and the predicted data (panel b), with mean of $0.07348$ nT and standard deviation of $0.3172$ nT.}
