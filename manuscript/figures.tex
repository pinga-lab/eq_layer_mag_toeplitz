...
\plot{carajas_tf_predicted_gridline}{width=8cm}{
	...
	(Figure \ref{fig:carajas_real_data_decimated_gridline}a) and the predicted data (panel a), with mean of $0.07979$ nT and standart deviation of $0.5060$ nT.}
...
\plot{carajas_tf_predicted_decimated}{width=8cm}{
	...
	(a) Predicted data and (b) Data residuals, defined as the difference between the observed  (Figure \ref{fig:carajas_real_data_decimated_gridline}b) and the predicted data (panel a), with mean of $0.07348$ nT and standart deviation of $0.3172$ nT.}
