...
\plot{synthetic_upward_residuals_comparison_v2}{width=10cm}{
...
\plot{synthetic_zrtp_residuals_comparison_v2}{width=10cm}{
...
\plot{carajas_upward_comparison}{width=13cm}{
	{(a) Upward continuation transformation of real data of Carajás Province, Brazil at $5, \,000$ m using our method.
	 (b) Upward continuation transformation of real data of Carajás Province, Brazil at $5, \,000$ m using the classical Fourier method.}
